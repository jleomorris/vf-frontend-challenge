...
locals {
  terragrunt_state_prefix = try(get_env("TERRAGRUNT_STATE_PREFIX"), "front-end-websites.pre-prod")
  ...
  terragrunt_environment = try(get_env("TERRAGRUNT_ENVIRONMENT"), "pre-prod")
